...
class Mixed:
    def __init__ (self, ingredients: list):
        ...
        self.__omnisention = self._omnisention_counter(raw_omnisention, self.__properties)
    ...
    def _omnisention_counter(self, raw_omnisention, properties): #подсчет омнисенции
        ...
        raw_omnisention = raw_omnisention + 5 * added_ihor_cristal - 5 * added_cenom_cristal 
